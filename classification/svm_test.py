...
# train_data = mat_reconstruct_svd.eigen_discard(train_data, [1], need_reshape=False)
# test_data = mat_reconstruct_svd.eigen_discard(test_data, [1], need_reshape=False)
